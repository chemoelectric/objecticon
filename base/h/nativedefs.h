...
NativeDef(io.ProgStream,close,io_ProgStream_close)
NativeDef(io.ProgStream,open_impl,io_ProgStream_open_impl)
...
NativeDef(posix.System,exec,posix_System_exec)
