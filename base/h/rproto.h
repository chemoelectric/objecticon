...
extern int Qlexge(dptr, dptr, dptr);
extern int Qlexgt(dptr, dptr, dptr);
extern int Qlexle(dptr, dptr, dptr);
extern int Qlexlt(dptr, dptr, dptr);
extern int Qlexne(dptr, dptr, dptr);
extern int Qneqv(dptr, dptr, dptr);
extern int Qnumeq(dptr, dptr, dptr);
extern int Qnumge(dptr, dptr, dptr);
extern int Qnumgt(dptr, dptr, dptr);
extern int Qnumle(dptr, dptr, dptr);
extern int Qnumlt(dptr, dptr, dptr);
extern int Qnumne(dptr, dptr, dptr);
extern int Qasgn(dptr, dptr, dptr);
extern int Qswap(dptr, dptr, dptr);
extern int Qvalue(dptr, dptr);
extern int Qsize(dptr, dptr);
extern int Qrefresh(dptr, dptr);
extern int Qnumber(dptr, dptr);
extern int Qcompl(dptr, dptr);
extern int Qneg(dptr, dptr);
extern int Qnull(dptr, dptr);
extern int Qnonnull(dptr, dptr);
