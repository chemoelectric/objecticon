...
#if HAVE_LIBPNG
typedef int png_structp, png_infop, png_bytep, png_byte, png_colorp, png_color, png_color_16, png_color_16p, png_size_t;
#endif
 ...
 */
   ...
   typedef int STARTUPINFOW, PROCESS_INFORMATION;
