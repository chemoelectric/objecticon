...
struct ucode_op ucode_op_table[] = {
    /*   0 */         INVALID,                                    
    /*   1 */         { Op_Asgn, "asgn", {0,0,0}, "\t%-12s" },                 
    /*   2 */         { Op_Bang, "bang", {0,0,0}, "\t%-12s" },                 
    /*   3 */         { Op_Cat, "cat", {0,0,0}, "\t%-12s" },                   
    /*   4 */         { Op_Compl, "compl", {0,0,0}, "\t%-12s" },               
    /*   5 */         { Op_Diff, "diff", {0,0,0}, "\t%-12s" },                 
    /*   6 */         { Op_Div, "div", {0,0,0}, "\t%-12s" },                   
    /*   7 */         { Op_Eqv, "eqv", {0,0,0}, "\t%-12s" },                   
    /*   8 */         { Op_Inter, "inter", {0,0,0}, "\t%-12s" },               
    /*   9 */         { Op_Lconcat, "lconcat", {0,0,0}, "\t%-12s" },           
    /*  10 */         { Op_Lexeq, "lexeq", {0,0,0}, "\t%-12s" },               
    /*  11 */         { Op_Lexge, "lexge", {0,0,0}, "\t%-12s" },               
    /*  12 */         { Op_Lexgt, "lexgt", {0,0,0}, "\t%-12s" },               
    /*  13 */         { Op_Lexle, "lexle", {0,0,0}, "\t%-12s" },               
    /*  14 */         { Op_Lexlt, "lexlt", {0,0,0}, "\t%-12s" },               
    /*  15 */         { Op_Lexne, "lexne", {0,0,0}, "\t%-12s" },               
    /*  16 */         { Op_Minus, "minus", {0,0,0}, "\t%-12s" },               
    /*  17 */         { Op_Mod, "mod", {0,0,0}, "\t%-12s" },                   
    /*  18 */         { Op_Mult, "mult", {0,0,0}, "\t%-12s" },                 
    /*  19 */         { Op_Neg, "neg", {0,0,0}, "\t%-12s" },                   
    /*  20 */         { Op_Neqv, "neqv", {0,0,0}, "\t%-12s" },                 
    /*  21 */         { Op_Nonnull, "nonnull", {0,0,0}, "\t%-12s" },           
    /*  22 */         { Op_Null, "null", {0,0,0}, "\t%-12s" },                 
    /*  23 */         { Op_Number, "number", {0,0,0}, "\t%-12s" },             
    /*  24 */         { Op_Numeq, "numeq", {0,0,0}, "\t%-12s" },               
    /*  25 */         { Op_Numge, "numge", {0,0,0}, "\t%-12s" },               
    /*  26 */         { Op_Numgt, "numgt", {0,0,0}, "\t%-12s" },               
    /*  27 */         { Op_Numle, "numle", {0,0,0}, "\t%-12s" },               
    /*  28 */         { Op_Numlt, "numlt", {0,0,0}, "\t%-12s" },               
    /*  29 */         { Op_Numne, "numne", {0,0,0}, "\t%-12s" },               
    /*  30 */         { Op_Plus, "plus", {0,0,0}, "\t%-12s" },                 
    /*  31 */         { Op_Power, "power", {0,0,0}, "\t%-12s" },               
    /*  32 */         { Op_Random, "random", {0,0,0}, "\t%-12s" },             
    /*  33 */         { Op_Rasgn, "rasgn", {0,0,0}, "\t%-12s" },               
    /*  34 */         { Op_Refresh, "refresh", {0,0,0}, "\t%-12s" },           
    /*  35 */         { Op_Rswap, "rswap", {0,0,0}, "\t%-12s" },               
    /*  36 */         { Op_Sect, "sect", {0,0,0}, "\t%-12s" },                 
    /*  37 */         { Op_Size, "size", {0,0,0}, "\t%-12s" },                 
    /*  38 */         { Op_Subsc, "subsc", {0,0,0}, "\t%-12s" },               
    /*  39 */         { Op_Swap, "swap", {0,0,0}, "\t%-12s" },                 
    /*  40 */         { Op_Tabmat, "tabmat", {0,0,0}, "\t%-12s" },             
    /*  41 */         { Op_Toby, "toby", {0,0,0}, "\t%-12s" },                 
    /*  42 */         { Op_Unions, "unions", {0,0,0}, "\t%-12s" },             
    ...
    /*  61 */         { Op_Invoke, "invoke", { TYPE_16,0,0 }, "\t%-12s %d" },            
    ...
    /* 199 */         INVALID,                                    
    /* 200 */         INVALID,                                    
    /* 201 */         { Op_Proc, "proc", { TYPE_STR,0,0 }, "%s %s" },             
    /* 202 */         { Op_Declend, "declend", {0,0,0}, "\t%-12s" },           
    ...
    /* 224 */         { Op_Vari, "vari", { TYPE_16,0,0 }, "\t%-12s %d" },                  
    /* 225 */         { Op_Lrgint, "lrgint", { TYPE_16,0,0 }, "\t%-12s %d" },                  
    /* 226 */         { Op_Invokei, "invokei", { TYPE_16,0,0 }, "\t%-12s %d" },            
    /* 227 */         { Op_Applyi, "applyi", {0,0,0}, "\t%-12s" },               
