...
NativeDef(graphics.Window,get_pixels,graphics_Window_get_pixels)
...
NativeDef(graphics.Window,set_icon,graphics_Window_set_icon)
...
NativeDef(graphics.Window,set_pixels,graphics_Window_set_pixels)
...
NativeDef(util.Timezone,get_system_timezone_impl,util_Timezone_get_system_timezone_impl)
NativeDef(util.Timezone,get_system_timezone_offset,util_Timezone_get_system_timezone_offset)
