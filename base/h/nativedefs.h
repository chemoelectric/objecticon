...
NativeDef(graphics.Window,drawable,graphics_Window_drawable)
NativeDef(graphics.Window,viewable,graphics_Window_viewable)
...
NativeDef(graphics.Window,get_references,graphics_Window_get_references)
...
NativeDef(graphics.Window,set_transient_for_impl,graphics_Window_set_transient_for_impl)
...
NativeDef(graphics.Pixels,get_rgba,graphics_Pixels_get_rgba)
...
NativeDef(graphics.Pixels,open_impl,graphics_Pixels_open_impl)
NativeDef(graphics.Pixels,get_format,graphics_Pixels_get_format)
NativeDef(graphics.Pixels,blank_impl,graphics_Pixels_blank_impl)
NativeDef(graphics.Pixels,get_palette_size,graphics_Pixels_get_palette_size)
NativeDef(graphics.Pixels,get_palette_rgba,graphics_Pixels_get_palette_rgba)
...
NativeDef(io.FileWorker,get_buffer,io_FileWorker_get_buffer)
...
NativeDef(lang.Prog,get_named_global,lang_Prog_get_named_global)
NativeDef(lang.Prog,get_named_globals,lang_Prog_get_named_globals)
