...
NativeDef(graphics.Window,is_resizable,graphics_Window_is_resizable)
NativeDef(graphics.Window,is_reversed,graphics_Window_is_reversed)
...
NativeDef(graphics.Window,set_reverse,graphics_Window_set_reverse)
