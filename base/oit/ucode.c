...
struct ucode_op ucode_op_table[] = {
    ...
    /* 154 */         { Uop_Augunions, "augunions", {0,0}, "\t%-12s" },
    /* 155 */         INVALID,
    /* 156 */         INVALID,
    /* 157 */         INVALID,
    /* 158 */         INVALID,
    ...
    /* 195 */         { Uop_Str, "str", { TYPE_16,0 }, "\t%-12s %d" },
    /* 196 */         { Uop_Var, "var", { TYPE_16,0 }, "\t%-12s %d" },
    /* 197 */         { Uop_Ucs, "ucs", { TYPE_16,0 }, "\t%-12s %d" },
    /* 198 */         { Uop_Cset, "cset", { TYPE_16,0 }, "\t%-12s %d" },
    /* 199 */         { Uop_Int, "int", { TYPE_16,0 }, "\t%-12s %d" },
    ...
    /* 206 */         { Uop_Con, "con", { TYPE_32, TYPE_BIN }, "\t%-12s %08o %s" },
    ...
    /* 224 */         INVALID,
    /* 225 */         { Uop_Lrgint, "lrgint", { TYPE_16,0 }, "\t%-12s %d" },                  
    ...
    /* 252 */         { Uop_Invokef, "invokef", { TYPE_16,TYPE_STR }, "\t%-12s %d %s" },
    /* 253 */         { Uop_Mutual, "mutual", { TYPE_16,0 }, "\t%-12s %d" },
    /* 254 */         { Uop_Apply, "apply", { 0,0 }, "\t%-12s" },
    /* 255 */         { Uop_Applyf, "applyf", { TYPE_STR,0 }, "\t%-12s %s" },
};
