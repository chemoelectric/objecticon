    ...
    type_case *dp1 of {
      ...
      named_var: {
            ...
            if ((prog = find_global(vp))) {
                *dp0 = *prog->Gnames[vp - prog->Globals]; 		/* global */
            }
                ...
                *dp0 = *proc0->lnames[vp - uf->fvars->desc];          /* argument/local */
            }
            else {
                LitStr("(temp)", dp0);
                return Failed;
 ...
 */
static void keyref(dptr dp1, dptr dp0)
{
