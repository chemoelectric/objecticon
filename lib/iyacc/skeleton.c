...
*/
    ...
    "",
    "      if \\yydebug then",
    "         io.write(\"yyn:\", yyn, \"  state:\", yystate, \"  char:\", yychar)",
    "",
    "      if yychar < 0 then {   # we want a char?",
    "        yychar := (yylval := @yylex).tok | 0    # get next token",
    "        if \\yydebug then {",
    "           if yychar = 0 then",
    "              io.write(\"yylex failed\")",
    "           else",
    "              io.write(\"yylex generated \", token_str(yychar))",
    "           }",
    "        } # yychar < 0",
    "",
    ...
    "",
    "        if \\yydebug then",
    "           io.write(\"state \", yystate, \", shifting to state \", yytable[yyn+1])",
    "",
    "        ##### NEXT STATE ####",
    ...
    "    if \\yydebug then",
    "       io.write(\"state \", yystate, \", reducing \", yym, \" by rule \", yyn, \" (\", yyrule[yyn+1], \")\")",
...
char *itrailer[] =
{
    ...
    "      if \\yydebug then",
    "         io.write(\"After reduction, shifting from state 0 to state \", YYFINAL)",
    "      yystate := YYFINAL          # explicitly say we're done",
    ...
    "        }",
    "      if \\yydebug then",
    "         io.write(\"After reduction, shifting from state \", statestk[1], \" to state \", yystate)",
