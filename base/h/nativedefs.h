...
NativeDef(graphics.Window,draw_image_data,graphics_Window_draw_image_data)
NativeDef(graphics.Window,draw_image_file,graphics_Window_draw_image_file)
NativeDef(graphics.Window,draw_image_string,graphics_Window_draw_image_string)
...
NativeDef(graphics.Window,set_image_data,graphics_Window_set_image_data)
NativeDef(graphics.Window,set_image_file,graphics_Window_set_image_file)
...
NativeDef(graphics.Window,write_image_file,graphics_Window_write_image_file)
#endif
