...
NativeDef(graphics.Window,palette_color_rgb_impl,graphics_Window_palette_color_rgb_impl)
NativeDef(graphics.Window,palette_key,graphics_Window_palette_key)
NativeDef(graphics.Window,palette_key_rgb,graphics_Window_palette_key_rgb)
...
NativeDef(graphics.Window,rectangle_impl,graphics_Window_rectangle_impl)
...
NativeDef(graphics.Pixels,filter,graphics_Pixels_filter)
...
NativeDef(lang.Text,lower,lang_Text_lower)
NativeDef(lang.Text,upper,lang_Text_upper)
NativeDef(lang.Text,caseless_cset,lang_Text_caseless_cset)
