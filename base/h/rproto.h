...
struct b_list   *alclist_raw_0  (word size, word nslots);
struct b_list   *alclist_raw_1  (word size, word nslots);
struct b_list   *alclist_0      (word size, word nslots);
struct b_list   *alclist_1      (word size, word nslots);
struct b_lelem  *alclstb_0      (word nslots);
struct b_lelem  *alclstb_1      (word nslots);
...
void copyimgdata(struct imgdata *dest, struct imgdata *src, int x, int y);
   ...
   void copyarea        (wbp w, int x, int y, int wd, int h, wbp w2, int x2, int y2);
...
struct b_ucs    *alcucs_0       (word n);
struct b_ucs    *alcucs_1       (word n);
